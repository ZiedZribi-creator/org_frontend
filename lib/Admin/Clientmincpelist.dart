...
import 'package:frontend/Admin/ClientDetail.dart';
...
class ClientMiniCpeList extends StatefulWidget {
  final int client_id;

  const ClientMiniCpeList({Key? key, required this.client_id})
      : super(key: key);

  @override
  _ClientMiniCpeListState createState() => _ClientMiniCpeListState();
}

class _ClientMiniCpeListState extends State<ClientMiniCpeList> {
  ...
  Future addCpes() async {
    ...
    //print(token);
    //var host = "efbf-102-25-171-90.eu.ngrok.io"; //10.0.2.2:8000
    var techAddCpeEndPoint = "/api/client/${widget.client_id}/add_cpe";
      ...
      showDialog(
          ...
          builder: (context) {
            return const AlertDialog(
                title: Text('Succes'),
                content: Text('Cpe Has been added to this Client'));
          });
